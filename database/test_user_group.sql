...
INSERT INTO projects (id_group, user, project_name, file_path) VALUES ('test_group', 'test_user', 'test_project','1afs.csv');
INSERT INTO projects (id_group, user, project_name, file_path) VALUES ('test_group2', 'adria', 'test_for2','1afas.csv');

INSERT INTO project_result (project_name, validation_result, date, user, algorithm, distance, groups, )

INSERT INTO projects VALUES ('adria', 'Monster_Hunter','mnt.csv', NULL);
